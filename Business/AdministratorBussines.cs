...
namespace Business
{
    public class AdministratorBussines
    {
        ...
        public Administrator initSessionAndroid(Administrator admi)
        {
            return this.administradorData.initSesssionAndroid(admi);
        }//initSession
        ...
        {
            return this.administradorData.administrators();
        }//administrator
